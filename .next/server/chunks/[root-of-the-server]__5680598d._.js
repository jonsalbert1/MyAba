...
"[project]/pages/api/quiz/list.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("quiz_items").select("domain,question,a,b,c,d,answer,rationale").eq("deck_id", deckId).order("id", {
        ascending: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5680598d._.js.map