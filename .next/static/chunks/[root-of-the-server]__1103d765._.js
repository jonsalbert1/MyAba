...
function DashboardPage() {
    _s();
    const [flashcardsCount, setFlashcardsCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [safmedsCount, setSafmedsCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [quizCount, setQuizCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [safmedsSessions, setSafmedsSessions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const last5Safmeds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[last5Safmeds]": ()=>[
                ...safmedsSessions
            ].slice(-5).reverse()
    }["DashboardPage.useMemo[last5Safmeds]"], [
        safmedsSessions
    ]);
    const last10Quiz = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[last10Quiz]": ()=>[
                ...quizHistory
            ].slice(-10).reverse()
    }["DashboardPage.useMemo[last10Quiz]"], [
        quizHistory
    ]);
    const safmedsAvgAcc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[safmedsAvgAcc]": ()=>{
            if (safmedsSessions.length === 0) return 0;
            const totals = safmedsSessions.reduce({
                "DashboardPage.useMemo[safmedsAvgAcc].totals": (acc, s)=>{
            ...
            }["DashboardPage.useMemo[safmedsAvgAcc].totals"], {
                correct: 0,
                total: 0
            });
    ...
    const quizAvgAcc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[quizAvgAcc]": ()=>{
            if (quizHistory.length === 0) return 0;
            const totals = quizHistory.reduce({
                "DashboardPage.useMemo[quizAvgAcc].totals": (acc, q)=>({
                        correct: acc.correct + q.correct,
                        total: acc.total + q.total
                    })
            }["DashboardPage.useMemo[quizAvgAcc].totals"], {
                correct: 0,
                total: 0
            });
            return totals.total ? Math.round(totals.correct / totals.total * 100) : 0;
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            last5Safmeds.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: [
                                                                ...
                                                                total,
                                                                " total",
                                                                typeof s.durationSec === "number" ? " · ".concat(s.durationSec, "s") : ""
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/pages/dashboard.tsx",
                                                            lineNumber: 160,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            last10Quiz.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-gray-600",
                                children: [
...
_s(DashboardPage, "3K0l864XZyNwcMjkpY2MHIuHE7s=");
_c = DashboardPage;
var _c;
