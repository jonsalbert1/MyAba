...
function Home() {
    _s();
    const [fcCount, setFcCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [qCount, setQCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
            ...
            async function loadCounts() {
                ...
                try {
                    const [fcRes, qRes] = await Promise.allSettled([
                        fetch("/api/flashcards/list?deckId=default").then({
                            "Home.useEffect.loadCounts": (r)=>r.json()
                        }["Home.useEffect.loadCounts"]),
                        fetch("/api/quiz/list?deckId=default").then({
                            "Home.useEffect.loadCounts": (r)=>r.json()
                        }["Home.useEffect.loadCounts"])
                    ]);
                    if (!cancelled) {
                        if (fcRes.status === "fulfilled" && Array.isArray(fcRes.value.records)) {
                            ...
                            setFcCount((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["loadFlashcards"])().length);
                        }
                        if (qRes.status === "fulfilled" && Array.isArray(qRes.value.records)) {
                            setQCount(qRes.value.records.length);
                        } else {
                            setQCount((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["loadQuiz"])().length);
                        }
                    }
                } catch (e) {
                    if (!cancelled) {
...
_s(Home, "Qvz5PpY8pZ9RKHcDGzAx8IjP/2o=");
_c = Home;
function Card(param) {
    let { title, meta, href } = param;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__58544a0a._.js.map