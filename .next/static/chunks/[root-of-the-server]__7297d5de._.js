...
"[project]/pages/flashcards.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FlashcardsPage() {
    ...
    const progress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FlashcardsPage.useMemo[progress]": ()=>{
            if (deck.length === 0) return "0 / 0";
            return "".concat(idx + 1, " / ").concat(deck.length);
        }
    }["FlashcardsPage.useMemo[progress]"], [
        idx,
        deck.length
    ...
    function onCSVUpload(e) {
        ...
        reader.onload = ()=>{
            ...
            // persist locally
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["saveFlashcards"])(rows);
            // optimistic UI
            setDeck(rows);
            setIdx(0);
            setFlipped(false);
...
_s(FlashcardsPage, "xpVOiP50cmuBAduVLv+i6xsOf38=");
_c = FlashcardsPage;
const btn = {
    padding: "10px 14px",
    borderRadius: 8,
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/flashcards.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/flashcards";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/flashcards.tsx [client] (ecmascript)");
    }
]);
...
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/flashcards.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__7297d5de._.js.map