  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <p className="mt-2 mb-8 text-gray-600">Choose a section to get started.</p>

        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/flashcards" className="rounded-2xl border p-4 hover:shadow-sm bg-white transition">
            <div className="text-lg font-medium">Flashcards</div>
            <div className="text-sm text-gray-500">Study terms &amp; definitions</div>
          </Link>

          <Link href="/safmeds" className="rounded-2xl border p-4 hover:shadow-sm bg-white transition">
            <div className="text-lg font-medium">SAFMEDS</div>
            <div className="text-sm text-gray-500">Timed fluency practice</div>
          </Link>

          <Link href="/quiz" className="rounded-2xl border p-4 hover:shadow-sm bg-white transition">
            <div className="text-lg font-medium">Quiz</div>
            <div className="text-sm text-gray-500">Scenario-based MCQs</div>
          </Link>

          <Link href="/admin" className="rounded-2xl border p-4 hover:shadow-sm bg-white transition">
