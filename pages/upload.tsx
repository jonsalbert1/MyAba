  ...
  const upload = async () => {
    ...
    try {
      ...
      if (!Array.isArray(payload) || payload.length === 0) {
        throw new Error("Provide an array of { term, def }");
      }

      const res = await fetch("/api/cards/bulk-upsert", {
        method: "POST",
